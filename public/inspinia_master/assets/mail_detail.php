...
<body>
    ...
    <?php include './lib/navigation.php';?>
     ...
     <!-- Mainly scripts -->
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/jquery-2.1.1.js"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/bootstrap.min.js"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/inspinia.js"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/plugins/pace/pace.min.js"></script>

    <!-- iCheck -->
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/inspinia/plugins/iCheck/icheck.min.js"></script>
    <script>
