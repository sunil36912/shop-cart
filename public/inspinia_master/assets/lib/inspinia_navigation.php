 <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav myselect" id="side-menu">
                    <li class="nav-header">
                    ...
                    <li class="active">
                        <a href="index.php"><i class="fa fa-th-large"></i> Dashboards</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="issue.php"><i class="fa fa-exclamation-triangle" style="color:white;"></i>Issues List</a>
                    </li>
                    <li>
                        <a href="pin_board.php"><i class="fa fa-clipboard"></i>Pin board</a>
                    </li>
                    <li>
                        <a href="tour.php"><i class="fa fa-flash" aria-hidden="true"></i>Training</a>
                    </li>
                    <li>
