    ...
    $(document).ready(function() {
       ...
       /* initialize the external events
        ...
        $('#calendar').fullCalendar({
            ...
            drop: function(moment ,title ) {
                
               var sta = $('calender').fullCalendar('getView').intervalStart;
               var end = $('calender').fullCalendar('getView').intervalEnd;
                alert(sta+" :: "+end);
               //alert(" Dropped on " + moment.format());
               // var calendar = $('#calendar').fullCalendar('getCalendar');
               // var m = calendar.moment();
               // var keyNames = Object.keys(title);
...
$(".external-event").mouseup(function(){
    alert('hello fsdfsf');
});
</script>
